 ...
 <?php $this->HeadScript()->appendFile('../../js/gen_validatorv31.js','text/javascript');?> 
 <?php $this->HeadScript()->appendFile('../../js/fg_ajax.js','text/javascript');?> 
  <?php $this->HeadScript()->appendFile('../../js/fg_moveable_popup.js','text/javascript');?> 
   <?php $this->HeadScript()->appendFile('../../js/fg_form_submitter.js','text/javascript');?> 
<div id='fg_formContainer'>
    <div id="fg_container_header">
        <div id="fg_box_Title">Contact usddddddddddd</div>
